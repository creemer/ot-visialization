define(["api/SplunkVisualizationBase","api/SplunkVisualizationUtils"], function(__WEBPACK_EXTERNAL_MODULE_121__, __WEBPACK_EXTERNAL_MODULE_122__) { return /******/ (function(modules) { // webpackBootstrap
/******/ 	// The module cache
...
/***/ (function(module, exports, __webpack_require__) {
	...
	!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(1), __webpack_require__(2), __webpack_require__(3), __webpack_require__(121), __webpack_require__(122), __webpack_require__(123)
	// Add required assets to this list
	], __WEBPACK_AMD_DEFINE_RESULT__ = function ($, _, moment, SplunkVisualizationBase, vizUtils, HighCharts) {
	    ...
	    return SplunkVisualizationBase.extend({
	        ...
	        formatData: function formatData(data) {
	            ...
	            if (_.isNaN(datum)) {
	                throw new SplunkVisualizationBase.VisualizationError('Only supports numbers');
	            }
	        ...
	        drilldownLabel: function drilldownLabel(event) {
	            var clickedTimestamp = new Date(event.point.x).getDate();
	            var obj4Drilldown = {
